      ...
      match char {
        ...
        '.' => {
          ...
          if maybe_char.is_some_and(|e| !e.is_ascii_digit()) {
            ...
            tknz.push(Token::new(TokenType::Float, lxme, tkn_pos, tkn_pos - i_p));
          }
        }
        ...
        _ => {
          if is_alpha(&char) {
            ...
            tknz.push(Token::new(TokenType::Id, lxme, tkn_pos, tkn_pos - i_p));
            ...
            if lxme.contains('.') {
              ...
              tknz.push(Token::new(TokenType::Int, lxme, tkn_pos, tkn_pos - i_p));
            }
          } else {
